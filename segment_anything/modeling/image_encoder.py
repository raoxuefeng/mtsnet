...
from .adapter import Adapter_Channel_Spatial_Attention as Adapter_Layer
...
class Attention(nn.Module):
    ...
    def __init__(
        ...
        self.adaper_train = adaper_train


    def forward(self, x: torch.Tensor) -> torch.Tensor:
        if self.adaper_train:
            # use adapter_train
            B, H, W, _ = x.shape
